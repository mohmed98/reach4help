...
import { firebaseRequest, IFirebaseRequest } from './index';
...
export interface ITimelineItem extends firebase.firestore.DocumentData {
  ...
  requestSnapshot: IFirebaseRequest;
...
export class TimelineItem implements ITimelineItem {
  constructor(
    ...
    requestSnapshot: firebaseRequest,
    action: TimelineItemAction,
  ...
  @IsObject()
  @ValidateNested()
  private _requestSnapshot: firebaseRequest;

  get requestSnapshot(): firebaseRequest {
    return this._requestSnapshot;
  }

  set requestSnapshot(value: firebaseRequest) {
  ...
  static factory(data: ITimelineItem): TimelineItem {
    return new TimelineItem(
      ...
      firebaseRequest.factory(data.requestSnapshot),
      data.action,
      data.createdAt,
    );
  }
